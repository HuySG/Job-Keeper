...
export const SOURCE_SEEDS: readonly SourceSeed[] = [
  ...
  },
  {
    ...
    // VẪN TẮT sau khi đo lại 11/09/2026. Đã thử bật bằng cờ useCurl và KHÔNG
    // đủ — xem note. Cấu hình dưới đây để nguyên vì nó đã kiểm đúng.
    isActive: false,
    note:
...
export const REJECTED_SOURCES: readonly { name: string; reason: string }[] = [
  ...
  // Glints ĐÃ CHUYỂN sang SOURCE_SEEDS ngày 11/09/2026 — kết luận
